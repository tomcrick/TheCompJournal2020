...
\subsection{Derived Weighed Graph Construction}

This graph is generated from the base graph, following the algorithm 
shown in Figure~\ref{fig:algorithm1}. It is a directed graph and that consists of two trend entities:
...
seven and nine in Figure~\ref{fig:algorithm2}. 
